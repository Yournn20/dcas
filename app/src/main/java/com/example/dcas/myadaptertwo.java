...
public class myadaptertwo extends RecyclerView.Adapter<myviewholdertwo> {
    private final Context context;
    private List<DataClass> dataList;
    public myadaptertwo(Context context, List<DataClass> dataList) {
...
class myviewholdertwo extends RecyclerView.ViewHolder{
    final ImageView recImage;
    final TextView recTitle;
    final TextView recDesc;
    final TextView recLang;
    final CardView recCard;
